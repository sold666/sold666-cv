...
\resumeItemListStart
\bulletItem{Participation in the Sber Business Profile project — a centralized customer database for Sberbank and its Ecosystem}
\bulletItem{Development and maintenance of RESTful services}
\bulletItem{Optimization of file transfer to the Federal Tax Service (FTS) API using multithreading, significantly improving system performance}
\bulletItem{Implementation of a distributed rate limiter based on Hazelcast with a headless service for pod coordination}
\bulletItem{Audit and update of dependencies to eliminate vulnerabilities (CVE), applying security fixes and maintaining secure development requirements}
\bulletItem{Involvement in technical upgrades: migration of services from Spring Boot 2 to Spring Boot 3 and Java 11 to Java 17}
\resumeItemListEnd
...
\textbf{Programming Languages:}{ Java, SQL, Python, JavaScript} \\ \vspace{3pt}

\textbf{Technologies:} Spring Boot, PostgreSQL, JUnit, Jenkins, Git, Maven, Docker, Kubernetes, Kafka, Prometheus, Grafana, OpenShift \\ \vspace{3pt}

\textbf{Tools:} IntelliJ IDEA, BitBucket, GitHub, GitLab, Postman, Allure, Jira, SonarQube
