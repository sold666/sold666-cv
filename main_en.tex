...
\resumeExpItem {\lineSeparatedText{Bercut Ltd.}{Junior QA Engineer}}{07.2023 -- ...}
\resumeItemListStart
...
\bulletItem{Usage of SOAP, REST API protocols}
\resumeItemListEnd
...
\textbf{Technologies:}{ Spring Boot, PostgreSQl, JUnit, Jenkins, Git, SVN, Apache Maven, Docker, K8s, Kafka} \ \vspace{3pt}
