...
\resumeItemListStart
\bulletItem{Участие в проекте Sber Business Profile — централизованной базе данных о клиентах Сбера и его Экосистемы}
\bulletItem{Разработка и поддержка REST-сервисов}
\bulletItem{Оптимизация передачи файлов ФНС API с помощью многопоточной обработки, значительно повысила производительность системы}
\bulletItem{Реализация распределённого rate limiter на базе Hazelcast с headless-сервисом для объединения подов}
\bulletItem{Аудит и обновление зависимостей для устранения уязвимостей (CVE), внедрение security-фиксов и поддержка требований безопасной разработки}
\bulletItem{Участие в техническом обновлении: перенос сервисов на Java 17 и миграция с Spring Boot 2 на Spring Boot 3}
\resumeItemListEnd
...
\textbf{Языки программирования:}{ Java, SQL, Python, JavaScript} \\ \vspace{3pt}

\textbf{Технологии:} Spring Boot, PostgreSQL, JUnit, Jenkins, Git, Maven, Docker, Kubernetes, Kafka, Prometheus, Grafana, OpenShift
